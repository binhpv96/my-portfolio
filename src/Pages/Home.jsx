...
const WORDS = ["Newbie In The New World", "Low - Tech Chill Guy"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/binhpv96" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/van-binh-pham-08605025a/" }
];
